...
export type CafeAndCoffeeShopFooterProps = {
  section: {
...
const defaultBrand: CafeAndCoffeeShopFooterProps["brand"] = {
...
const defaultCopyright: CafeAndCoffeeShopFooterProps["copyright"] = {
  text: createTextField("© 2026 {{name}}"),
  styles: defaultTextStyles,
  fontColor: undefined,
};

const defaultAppBadges: CafeAndCoffeeShopFooterProps["appBadges"] = {
  items: [
    {
      cta: createCTA("Download on the App Store", "#", "app-store"),
    },
...
export const CafeAndCoffeeShopFooterDefaultProps: CafeAndCoffeeShopFooterProps =
  {
    section: {
      backgroundColor: {
...
> = (props) => {
  ...
  return (
    <AnalyticsScopeProvider
      name={`CafeAndCoffeeShopFooter${getAnalyticsScopeHash(props.id ?? "default")}`}
    >
      <VisibilityWrapper
