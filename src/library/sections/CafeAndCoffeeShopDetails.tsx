...
export type CafeAndCoffeeShopDetailsProps = {
  section: {
...
const CafeAndCoffeeShopDetailsDefaultProps: CafeAndCoffeeShopDetailsProps =
  {
    section: {
      backgroundColor: {
...
> = (props) => {
  ...
  return (
    <AnalyticsScopeProvider
      name={`CafeAndCoffeeShopDetails${getAnalyticsScopeHash(props.id ?? "default")}`}
    >
      <VisibilityWrapper
